...
xRange1 = 0.5*(0.0072 * PS30.PS30_GetPosRange(1,ax1))
xRange2 = 0.5*(0.0072 * PS30.PS30_GetPosRange(1,ax2))
...
PS30.PS30_SetTarget(1, ax1, c_double(xRange1))
PS30.PS30_SetTarget(1, ax2, c_double(xRange2))

#result = PS30.PS30_MoveEx(1, ax1, c_double(xRange1), 1)
#result = PS30.PS30_MoveEx(1, ax2, c_double(xRange2), 1)

PS30.PS30_MultiGoTarget(1,3,0)
    ...
    if imu_node is not None:
        while True:
            ...
            if imu_data is not None:
                ...
                transform = adjust_for_motion(0, 0, roll, pitch, yaw)
                #transform = motionCompensation(0, 0, roll, pitch, yaw)
