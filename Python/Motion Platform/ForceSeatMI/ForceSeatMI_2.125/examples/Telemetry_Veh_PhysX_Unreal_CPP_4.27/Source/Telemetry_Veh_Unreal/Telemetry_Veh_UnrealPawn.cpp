...
#include "Telemetry_Veh_UnrealWheelRear.h"
...
const FName ATelemetry_Veh_UnrealPawn::LookUpBinding("LookUp");
const FName ATelemetry_Veh_UnrealPawn::LookRightBinding("LookRight");
...
void ATelemetry_Veh_UnrealPawn::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	PlayerInputComponent->BindAxis("MoveForward", this, &ATelemetry_Veh_UnrealPawn::MoveForward);
	PlayerInputComponent->BindAxis("MoveRight", this, &ATelemetry_Veh_UnrealPawn::MoveRight);
	PlayerInputComponent->BindAxis("LookUp");
	PlayerInputComponent->BindAxis("LookRight");

	PlayerInputComponent->BindAction("Handbrake", IE_Pressed, this, &ATelemetry_Veh_UnrealPawn::OnHandbrakePressed);
	PlayerInputComponent->BindAction("Handbrake", IE_Released, this, &ATelemetry_Veh_UnrealPawn::OnHandbrakeReleased);
	PlayerInputComponent->BindAction("SwitchCamera", IE_Pressed, this, &ATelemetry_Veh_UnrealPawn::OnToggleCamera);

	PlayerInputComponent->BindAction("ResetVR", IE_Pressed, this, &ATelemetry_Veh_UnrealPawn::OnResetVR); 
}

void ATelemetry_Veh_UnrealPawn::MoveForward(float Val)
{
	GetVehicleMovementComponent()->SetThrottleInput(Val);
}

void ATelemetry_Veh_UnrealPawn::MoveRight(float Val)
{
	GetVehicleMovementComponent()->SetSteeringInput(Val);
}

void ATelemetry_Veh_UnrealPawn::OnHandbrakePressed()
{
	GetVehicleMovementComponent()->SetHandbrakeInput(true);
}

void ATelemetry_Veh_UnrealPawn::OnHandbrakeReleased()
{
	GetVehicleMovementComponent()->SetHandbrakeInput(false);
}

void ATelemetry_Veh_UnrealPawn::OnToggleCamera()
{
	EnableIncarView(!bInCarCameraActive);
}

void ATelemetry_Veh_UnrealPawn::EnableIncarView(const bool bState, const bool bForce)
{
...
void ATelemetry_Veh_UnrealPawn::Tick(float Delta)
{
	...
	if (bHMDActive == false)
	{
		...
		{
			auto HeadRotation = InternalCamera->GetRelativeRotation();
...
void ATelemetry_Veh_UnrealPawn::OnResetVR()
{
#if HMD_MODULE_INCLUDED
...
void ATelemetry_Veh_UnrealPawn::UpdateHUDStrings()
{
...
void ATelemetry_Veh_UnrealPawn::SetupInCarHUD()
{
